                        ...
                        <div class="col-md-10 col-lg-7">
                            <div class="text-box ">
                                <div class="content wow text-focus-in ">
                                    ...
                                    <h1 class="title mt-3">{{$header->title}}</h1>
                                    <p class="p mt-3">
                                        {{$header->description}}
                                    </p>
                    ...
                    <div class="swiper-wrapper">
                        @foreach ($clients as $client)
                            <div class="swiper-slide">
                                <img src="../storage/app/public/images/{{$client->image}}" alt="" class="partner-img wow zoomIn"
            ...
            <div class="container">
                <div class="row">
                    @foreach ($abouts as $about)
                        <div class="col-md-6">
                            <div class="img-box">
                                <img src="{{asset($about->image)}}" alt="" class="main-img wow fadeInRight"
                                    data-wow-duration="2s" />
                                <img src="{{asset($about->image)}}" alt="" class="card-img wow fadeInLeft"
                        ...
                        <div class="col-md-6">
                            <div class="text-box wow text-focus-in" data-wow-duration="2s">
                                <div class="text-h">
                                    ...
                                    <h1 class="title mt-3">{{$about->title}}</h1>
                                </div>
                                <p class="p mt-3 ">
                                    {{$about->description}}
                                </p>
                        ...
                        <div class="col-lg-4">
                            <div class="card wow swing-in-top-bck" data-wow-duration="1.5s">
                                <div class="content">
                                    ...
                                    <h5 class="title mt-4">{{$goal->title}}</h5>
                                    <p class="p">
                                        {{$goal->subtitle}}
                                    </p>
                    ...
                    <div class="row">
                        @foreach ($latests as $latest)
                            <div class="col-lg-3 col-md-6">
                                <a href="images/{{$latest->image}}" data-fancybox="images">
                                    <img src="images/{{$latest->image}}" alt="" class="port_img sm" />
                                </a>
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <img src="images/{{$partner->image}}" alt="" class="partner-img wow zoomIn" data-wow-duration="2s" />
                    </div>
                    @endforeach
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="text-box wow text-focus-in">
                            ...
                            <div class="links pt-2">
                                <a href="#"><img src="images/icons/contact-1.svg" alt="" class="icon" />{{$contact->address}}</a>
                                <a href="#"><img src="images/icons/contact-2.svg" alt="" class="icon" />{{$contact->phone}}</a>
                                <a href="#"><img src="images/icons/contact-3.svg" alt="" class="icon" />{{$contact->email}}</a>
